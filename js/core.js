!(function (e, t) {
    ...
    return (function (e) {
        ...
        function (e, t, n) {
            (function (t) {
                for (var r = n(11), o = "undefined" == typeof window ? t : window, i = ["moz", "webkit"], a = "AnimationFrame", s = o["request" + a], u = o["cancel" + a] || o["cancelRequest" + a], c = 0; !s && c < i.length; c++)
                ...
                function e(t, n) {
                    ...
                    if (
                        ...
                        _(this, "pasteString", function (e) {
                            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                            return i(e) ? u.typeOutHTMLString(e, t, !0) : (e && u.addEventToQueue(w, { character: e, node: t }), u);
                        }),
                            ...
                            if (r.length > 0)
                                for (var o = 0; o < r.length; o++) {
                                    var i = r[o],
                                        s = i.innerHTML;
                                    i && 3 !== i.nodeType
                                        ? ((i.innerHTML = ""), u.addEventToQueue(h, { node: i, parentNode: t }), n ? u.pasteString(s, i) : u.typeString(s, i))
                                        : i.textContent && (n ? u.pasteString(i.textContent, t) : u.typeString(i.textContent, t));
                                }
                            return u;
                        }),
                                    ...
                                    switch ((u.logInDevMode({ currentEvent: r, state: u.state, delay: i }), a)) {
                                        ...
                                        case c:
                                            var N = b.character,
                                                ...
                                                O = _;
                                            u.options.onCreateTextNode && "function" == typeof u.options.onCreateTextNode && (O = u.options.onCreateTextNode(N, _)),
                                                O && (C ? C.appendChild(O) : u.state.elements.wrapper.appendChild(O)),
                                                (u.state.visibleNodes = [].concat(S(u.state.visibleNodes), [{ type: E, character: N, node: O }]));
                                            break;
                                        case l:
                                        ...
                                        case h:
                                            var D = r.eventArgs,
                                                P = D.node,
                                                k = D.parentNode;
                                            k ? k.appendChild(P) : u.state.elements.wrapper.appendChild(P), (u.state.visibleNodes = [].concat(S(u.state.visibleNodes), [{ type: T, node: P, parentNode: k || u.state.elements.wrapper }]));
                                            break;
                                        case p:
                                            ...
                                            for (var H = 0, I = R.length; H < I; H++) F.push({ eventName: d, eventArgs: { removingCharacterNode: !1 } });
                                            Q && F.push({ eventName: m, eventArgs: { speed: u.options.deleteSpeed, temp: !0 } }), n.unshift.apply(n, F);
                                            break;
                                        case d:
                                            ...
                                            if (u.state.visibleNodes.length) {
                                                var q = u.state.visibleNodes.pop(),
                                                    ...
                                                    Y = q.node,
                                                    V = q.character;
                                                u.options.onRemoveNode && "function" == typeof u.options.onRemoveNode && u.options.onRemoveNode({ node: Y, character: V }),
